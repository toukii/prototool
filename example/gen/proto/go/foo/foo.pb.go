...
type HelloServiceClient interface {
	// Foo does a foo.
	Foo(ctx context.Context, in *foo_sub.Dep, opts ...grpc.CallOption) (*FooResponse, error)
	// Bar does a bar.
...
func (c *helloServiceClient) Foo(ctx context.Context, in *foo_sub.Dep, opts ...grpc.CallOption) (*FooResponse, error) {
	out := new(FooResponse)
...
type HelloServiceServer interface {
	// Foo does a foo.
	Foo(context.Context, *foo_sub.Dep) (*FooResponse, error)
	// Bar does a bar.
...
func _HelloService_Foo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).Foo(ctx, req.(*foo_sub.Dep))
	}
...
var fileDescriptorFoo = []byte{
	...
	,
}
